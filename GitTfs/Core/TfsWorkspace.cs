...
namespace Sep.Git.Tfs.Core
{
    public class TfsWorkspace : ITfsWorkspace
    {
        ...
        public long Checkin()
        {
            ...
            var newChangeset = _workspace.Checkin(pendingChanges, _checkinOptions.CheckinComment, null, workItemInfos, policyOverride, _checkinOptions.QueueBuildForGatedCheckIn);
            if(newChangeset == 0)
            {
